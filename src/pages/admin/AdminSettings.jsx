...
const SETTING_GROUPS = [
  {
    ...
    icon: Building2,
    fields: [
      { key: 'company_name', label: 'Company Name', placeholder: 'ShipMate' },
  ...
  },
  {
    ...
    icon: Mail,
    fields: [
      { key: 'contact_email', label: 'Contact Email', placeholder: 'info@shipmate.com', type: 'email' },
  ...
  },
  {
    ...
    icon: Globe,
    fields: [
      { key: 'social_twitter', label: 'Twitter/X URL', placeholder: 'https://twitter.com/shipmate' },
      { key: 'social_linkedin', label: 'LinkedIn URL', placeholder: 'https://linkedin.com/company/shipmate' },
      { key: 'social_facebook', label: 'Facebook URL', placeholder: 'https://facebook.com/shipmate' },
      { key: 'social_instagram', label: 'Instagram URL', placeholder: 'https://instagram.com/shipmate' },
    ],
  },
  {
    heading: 'Email / SMTP',
    ...
    fields: [
      ...
      { key: 'smtp_from', label: 'From Address', placeholder: 'no-reply@shipmate.com', type: 'email' },
    ],
  },
];
