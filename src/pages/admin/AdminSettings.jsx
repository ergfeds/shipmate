...
const SETTING_GROUPS = [
  ...
  },
  {
    ...
    icon: Mail,
    fields: [
      { key: 'contact_email', label: 'Contact Email', placeholder: 'info@Cargo Parcel Expressgloballogistics.com', type: 'email' },
  ...
  },
  {
    ...
    icon: Globe,
    fields: [
      { key: 'social_twitter', label: 'Twitter/X URL', placeholder: 'https://twitter.com/Cargo Parcel Expressglobalcargo' },
      { key: 'social_linkedin', label: 'LinkedIn URL', placeholder: 'https://linkedin.com/company/Cargo Parcel Expressglobalcargo' },
      { key: 'social_facebook', label: 'Facebook URL', placeholder: 'https://facebook.com/Cargo Parcel Expressglobalcargo' },
      { key: 'social_instagram', label: 'Instagram URL', placeholder: 'https://instagram.com/Cargo Parcel Expressglobalcargo' },
    ],
  },
  {
    heading: 'Email (SMTP)',
    ...
    fields: [
      ...
      { key: 'smtp_from', label: 'From Address', placeholder: 'noreply@Cargo Parcel Expressgloballogistics.com', type: 'email' },
    ],
  },
];
