...
const MILESTONES = [
  { year: '2007', event: 'ShipMate founded in New York with regional road freight operations.' },
      ...
      <main style={{ paddingTop: 'var(--nav-h)' }}>
        ...
        <div style={{ background: 'var(--grad-hero)', padding: 'clamp(80px, 12vw, 140px) 0', borderBottom: '1px solid hsla(0,0%,100%,0.05)' }}>
          <div className="container">
            <div className="section-label"><span>About ShipMate</span></div>
            ...
            <p className="text-body" style={{ maxWidth: 540, fontSize: '1.05rem' }}>
              Founded in 2007, ShipMate began as a regional freight company with a bold vision: to redefine
        ...
        <section className="section">
          <div className="container">
            <div style={{ borderRadius: 'var(--radius-xl)', overflow: 'hidden', border: '1px solid hsla(0,0%,100%,0.07)', height: 460 }}>
              <img src="/about-warehouse.png" alt="ShipMate state-of-the-art warehouse" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          </div>
        </section>
