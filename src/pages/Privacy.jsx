      ...
      <main style={{ paddingTop: 'var(--nav-h)' }}>
        <div className="container" style={{ padding: '64px clamp(16px,4vw,48px)', maxWidth: 820 }}>
          ...
          {[
            ...
            { title: '6. Your Rights', body: 'Subject to applicable law, you have the right to access, rectify, erase, and port your data. You may also object to processing and withdraw consent at any time. Contact privacy@Cargo Parcel Expressgloballogistics.com to exercise these rights.' },
            ...
            { title: '8. Contact Us', body: 'For privacy-related questions or to exercise your rights, contact our Data Protection Officer at privacy@Cargo Parcel Expressgloballogistics.com or by post to our registered address.' },
          ].map(({ title, body }) => (
